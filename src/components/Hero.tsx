          ...
          <div>
            ...
            <div className="reveal flex flex-wrap justify-center gap-4">
              <a
                ...
                className="btn-primary ripple inline-flex items-center justify-center gap-2.5 px-7 py-3.5 rounded-xl text-[15px] font-bold text-white no-underline flex-1 min-w-[180px]"
              >
              ...
              <a
                ...
                className="btn-secondary ripple inline-flex items-center justify-center gap-2.5 px-7 py-3.5 rounded-xl text-[15px] font-bold text-white no-underline flex-1 min-w-[180px]"
              >
